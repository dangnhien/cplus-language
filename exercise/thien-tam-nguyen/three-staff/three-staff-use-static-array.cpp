...
{
    return (size_t)(soGioSua * 5); // 5 = 5 000
}
...
{
    return (size_t)(so_hang_giao * 3); // 3 = 3 000
}
...
// funstion conversion two object for each other
...
// funstion sort list decrease according to salary
...
int main()
{
    ...
    int n = 0; // amount staff sua ong nuoc
    int m = 0; // amount staff giao hang
    int l = 0; // amount staff xe om
